...
namespace TianWen.XiaoZhen1Qu.Interface
{
    public interface ISHFW_BLL : IBaseBLL
    {
        ...
        object SaveSHFW_KSXSHSJBXX(JCXX jcxx, SHFW_KSXSHSJBXX jbxx, List<PHOTOS> photos);

        object LoadSHFW_KSXSHSJBXX(string ID);
        ...
        object SaveSHFW_ESHSJBXX(JCXX jcxx, SHFW_ESHSJBXX jbxx, List<PHOTOS> photos);

        object LoadSHFW_ESHSJBXX(string ID);
    }
}
