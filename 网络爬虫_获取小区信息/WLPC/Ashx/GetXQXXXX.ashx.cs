...
namespace WLPC.Ashx
{
    ...
    public class GetXQXXXX : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                //无数据：aba,阿坝|ali,阿里|alaer,阿拉尔|alashanm,阿拉善盟|
                //数据没导全：beijing,北京|chengdu,成都|chongqing,重庆|
                //已到全：anshan,鞍山|anyang,安阳|anqing,安庆|ankang,安康|anshun,安顺|akesu,阿克苏|fz,福州|baoding,保定|baotou,包头|binzhou,滨州|baoji,宝鸡|bengbu,蚌埠|benxi,本溪|beihai,北海|bayinguoleng,巴音郭楞|bazhong,巴中|bayannaoer,巴彦淖尔市|bozhou,亳州|baiyin,白银|baicheng,白城|baise,百色|baishan,白山|boertala,博尔塔拉|bijie,毕节|baoshan,保山|
