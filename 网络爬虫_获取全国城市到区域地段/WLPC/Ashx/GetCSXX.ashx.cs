        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < list.Length; i++)
                {
                    ...
                    var jobj = JsonHelper.ConvertJsonToObject<List<first>>(result);
                    //var jobj = JsonConvert.DeserializeObject<List<children>>(result);
