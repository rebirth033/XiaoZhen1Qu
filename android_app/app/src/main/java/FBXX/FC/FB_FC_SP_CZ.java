...
public class FB_FC_SP_CZ extends Base implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fb_fc_sp_cz);
        initView();
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_FC_SP_LB") {
            Intent intent = new Intent(FB_FC_SP_CZ.this, FB_FC_SP_LB.class);
            startActivity(intent);
            finish();//关闭当前页面
        }
        if (id == "FB_FC_SP_CZ2") {
            Intent intent = new Intent(FB_FC_SP_CZ.this, FB_FC_SP_CZ2.class);
        ...
        if (id == "FB_FC_SP_SPLX") {
            splxWindow = new FB_FC_SP_SPLX(FB_FC_SP_CZ.this, splxOnClick);
            splxWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            splxWindow.SetCheck(mtvsplx.getText().toString());
        }
        if (id == "FB_FC_MJ") {
            mjWindow = new FB_FC_MJ(FB_FC_SP_CZ.this, mjOnClick);
            mjWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            mjWindow.metmj.setText(mtvmj.getText());
        }
        if (id == "FB_FC_SP_MK") {
            mkcgjsWindow = new FB_FC_SP_MKCGJS(FB_FC_SP_CZ.this, mkcgjsOnClick, "MK");
            mkcgjsWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            mkcgjsWindow.mtvmk.setText(mtvmk.getText());
            mkcgjsWindow.mtvcg.setText(mtvcg.getText());
            mkcgjsWindow.mtvjs.setText(mtvjs.getText());
        }
        if (id == "FB_FC_SP_CG") {
            mkcgjsWindow = new FB_FC_SP_MKCGJS(FB_FC_SP_CZ.this, mkcgjsOnClick, "CG");
            mkcgjsWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            mkcgjsWindow.mtvmk.setText(mtvmk.getText());
            mkcgjsWindow.mtvcg.setText(mtvcg.getText());
            mkcgjsWindow.mtvjs.setText(mtvjs.getText());
        ...
        if (id == "FB_FC_SP_JS") {
            mkcgjsWindow = new FB_FC_SP_MKCGJS(FB_FC_SP_CZ.this, mkcgjsOnClick, "JS");
            mkcgjsWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            mkcgjsWindow.mtvmk.setText(mtvmk.getText());
            mkcgjsWindow.mtvcg.setText(mtvcg.getText());
            mkcgjsWindow.mtvjs.setText(mtvjs.getText());
        ...
        if (id == "FB_FC_SP_JYZT") {
            jyztWindow = new FB_FC_SP_JYZT(FB_FC_SP_CZ.this, jyztOnClick);
            jyztWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            jyztWindow.SetCheck(mtvjyzt.getText().toString());
        }
        if (id == "FB_FC_SP_JYHY") {
            jyhyWindow = new FB_FC_SP_JYHY(FB_FC_SP_CZ.this, jyhyOnClick);
            jyhyWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            jyhyWindow.SetCheck(mtvjyhy.getText().toString());
        }
        if (id == "FB_FC_ZJ") {
            zjWindow = new FB_FC_ZJ(FB_FC_SP_CZ.this, zjOnClick);
            zjWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            zjWindow.metzj.setText(mtvzj.getText());
        }
        if (id == "FB_FC_SP_LC") {
            lcWindow = new FB_FC_SP_LC(FB_FC_SP_CZ.this, lcOnClick);
            lcWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            lcWindow.mwvc.setWheelItemList(WheelStyle.createCString());
            lcWindow.mwvgjc.setWheelItemList(WheelStyle.createGJCString());
        }
        if (id == "FB_FC_YFFS") {
            yffsWindow = new FB_FC_YFFS(FB_FC_SP_CZ.this, yffsOnClick);
            yffsWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            yffsWindow.mwvy.setWheelItemList(WheelStyle.createYString());
            yffsWindow.mwvf.setWheelItemList(WheelStyle.createFString());
        }
        if (id == "FB_FC_LXRSF") {
            lxrsfWindow = new FB_FC_LXRSF(FB_FC_SP_CZ.this, lxrsfOnClick);
            lxrsfWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        }
        if (id == "FB_FC_LXRLXDH") {
            lxrlxdhWindow = new FB_FC_LXRLXDH(FB_FC_SP_CZ.this, lxrlxdhOnClick);
            lxrlxdhWindow.showAtLocation(FB_FC_SP_CZ.this.findViewById(R.id.fb_fc_sp_cz), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        }
    }
