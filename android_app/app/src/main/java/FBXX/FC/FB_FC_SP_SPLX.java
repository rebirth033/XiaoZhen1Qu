...
public class FB_FC_SP_SPLX extends PopupWindow implements View.OnClickListener {

    private View mMenuView;
    private LinearLayout mllSPLXLB;

    public FB_FC_SP_SPLX(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.fb_fc_sp_splx, null);
    ...
    private void initView(View.OnClickListener itemsOnClick) {
        ...
        mllSPLXLB = (LinearLayout) mMenuView.findViewById(R.id.ll_fb_fc_splx_body);
    ...
    public void HandlerSPLX() {
        try {
            String JList = "[{\"CODENAME\":\"商业街商铺\"},{\"CODENAME\":\"写字楼配套\"},{\"CODENAME\":\"社区底商\"},{\"CODENAME\":\"档口摊位\"}]";
    ...
    public String GetCheck(){
        ...
        List<View> viewList = Base.getAllChildViews(mllSPLXLB);
    ...
    public void SetCheck(String splx){
        ...
        for(int i = 0; i < viewList.size(); i++) {
            if(viewList.get(i).getClass().toString().contains("LinearLayout")){
                ...
                TextView tv = (TextView)vs.get(0);
                ImageView iv = (ImageView)vs.get(1);
                if(tv.getText().toString().indexOf(splx) != -1) {
