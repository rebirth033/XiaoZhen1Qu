...
public class FB_FC_QT_ZR extends Base implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fb_fc_qt_zr);
        initView();
    }
    ...
    private void initView() {
        ...
        findViewById(R.id.ll_qt_zrf).setOnClickListener(this);
        ...
        mtvzrf = (TextView) findViewById(R.id.tv_qt_zrf);
    ...
    public void YMTZ(String id) {
        if (id == "FB_FC_QT_LB") {
            Intent intent = new Intent(FB_FC_QT_ZR.this, FB_FC_QT_LB.class);
            startActivity(intent);
            finish();//关闭当前页面
        }
        if (id == "FB_FC_QT_LX") {
            qtlxWindow = new FB_FC_QT_LX(FB_FC_QT_ZR.this, qtlxOnClick);
            qtlxWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            qtlxWindow.mtvlx.setText(mtvlx.getText());
            qtlxWindow.mwvlx.setWheelItemList(WheelStyle.createQTLXString());
        }
        if (id == "FB_FC_MJ") {
            mjWindow = new FB_FC_MJ(FB_FC_QT_ZR.this, mjOnClick);
            mjWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            mjWindow.metmj.setText(mtvmj.getText());
        }
        if (id == "FB_FC_ZJ") {
            zjWindow = new FB_FC_ZJ(FB_FC_QT_ZR.this, zjOnClick);
            zjWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            zjWindow.metzj.setText(mtvzj.getText());
        }
        if (id == "FB_FC_QT_ZRF") {
            zrfWindow = new FB_FC_SJ(FB_FC_QT_ZR.this, zrfOnClick);
            zrfWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
            zrfWindow.metsj.setText(mtvzrf.getText());
            zrfWindow.mtvtext.setText("转让费");
            zrfWindow.mtvtitle.setText("请输入转让费");
        }
        if (id == "FB_FC_LXRSF") {
            lxrsfWindow = new FB_FC_LXRSF(FB_FC_QT_ZR.this, lxrsfOnClick);
            lxrsfWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        }
        if (id == "FB_FC_LXRLXDH") {
            lxrlxdhWindow = new FB_FC_LXRLXDH(FB_FC_QT_ZR.this, lxrlxdhOnClick);
            lxrlxdhWindow.showAtLocation(FB_FC_QT_ZR.this.findViewById(R.id.fb_fc_qt_zr), Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0);
        }
    }
    ...
    //转让费页面按钮监听
    private View.OnClickListener zrfOnClick = new View.OnClickListener(){
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.ivqx:
                    zjWindow.dismiss();
                ...
                case R.id.tvqd:
                    zrfWindow.dismiss();
                    mtvzrf.setText(zrfWindow.metsj.getText());

                    fb_fc_qt.ZRF = new BigDecimal(zrfWindow.metsj.getText().toString().replace("元","").replace("万",""));
                    break;
            }
        }
    };
