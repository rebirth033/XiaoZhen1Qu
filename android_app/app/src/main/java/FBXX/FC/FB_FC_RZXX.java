...
public class FB_FC_RZXX extends PopupWindow implements View.OnClickListener {
    ...
    public FB_FC_RZXX(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ll_rzxx_kfsj:
                ...
                mwvkfsj.setWheelItemList(WheelStyle.createKFSJString());
                break;
            case R.id.ll_rzxx_yzrs:
                ...
                mwvyzrs.setWheelItemList(WheelStyle.createYZRSString());
                break;
            case R.id.ll_rzxx_rzsj:
                ...
                mwvyear.setWheelItemList(WheelStyle.createYearString());
                mwvmonth.setWheelItemList(WheelStyle.createMonthString());
                mwvday.setWheelItemList(WheelStyle.createDayString());
                break;
