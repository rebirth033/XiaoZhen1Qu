...
public class FB_FC_LXRLXDH extends PopupWindow implements View.OnClickListener {

    private View mMenuView;
    public EditText metLXDH;

    public FB_FC_LXRLXDH(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.fb_fc_lxrlxdh, null);
    ...
    private void findById(View.OnClickListener itemsOnClick) {
        ...
        metLXDH = (EditText) mMenuView.findViewById(R.id.etlxdh);
        ...
        metLXDH.setOnClickListener(itemsOnClick);
    }
    ...
    public void Input(String value) {
        metLXDH.setText(metLXDH.getText() + value);
    }
    //删除
    public void Delete() {
        if(metLXDH.length() == 2)
            ...
            metLXDH.setText(metLXDH.getText().toString().substring(0,metLXDH.length() - 2));
    }
}
