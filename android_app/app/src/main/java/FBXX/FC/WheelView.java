...
public class WheelView extends View {
    ...
    public void setWheelStyle(int style) {
        itemList = WheelStyle.createSString();
        if (itemList != null) {
    ...
    private void init(Context context) {
        ...
        selectPaint.setColor(Color.parseColor("#000000"));
        selectPaint.setTextSize(80);
        ...
        centerLinePaint.setColor(Color.parseColor("#999999"));
    ...
    private void drawCenterText(Canvas canvas) {
     ...
     //canvas 画布,position 距离mCurrentSelected的差值,type 1表示向下绘制，-1表示向上绘制
