...
public class FB_XXYL extends Base implements View.OnClickListener {

    private LinearLayout mllFB_XXYL;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_xxyl);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_XXYL = (LinearLayout) findViewById(R.id.LL_FB_XXYL_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_XXYL.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "93");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_XXYL.addView(llitem_first);
