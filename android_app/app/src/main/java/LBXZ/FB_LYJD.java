...
public class FB_LYJD extends Base implements View.OnClickListener {

    private LinearLayout mllFB_LYJD;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_lyjd);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_LYJD = (LinearLayout) findViewById(R.id.LL_FB_LYJD_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_LYJD.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "95");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_LYJD.addView(llitem_first);
