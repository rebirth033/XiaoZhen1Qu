...
public class FB_ZXJC extends Base implements View.OnClickListener {

    private LinearLayout mllFB_ZXJC;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_zxjc);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_ZXJC = (LinearLayout) findViewById(R.id.LL_FB_ZXJC_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_ZXJC.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "97");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_ZXJC.addView(llitem_first);
