...
public class FB_LR extends Base implements View.OnClickListener {

    private LinearLayout mllFB_LR;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_lr);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_LR = (LinearLayout) findViewById(R.id.LL_FB_LR_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_LR.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "94");
