...
public class FB_PFCG extends Base implements View.OnClickListener {

    private LinearLayout mllFB_PFCG;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_pfcg);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_PFCG = (LinearLayout) findViewById(R.id.LL_FB_PFCG_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_PFCG.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "7");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_PFCG.addView(llitem_first);
