...
public class FB_ESWP extends Base implements View.OnClickListener {

    private LinearLayout mllFB_ESWP;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_eswp);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_ESWP = (LinearLayout) findViewById(R.id.LL_FB_ESWP_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_ESWP.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "3");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_ESWP.addView(llitem_first);
