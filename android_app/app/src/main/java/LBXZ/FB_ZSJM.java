...
public class FB_ZSJM extends Base implements View.OnClickListener {

    private LinearLayout mllFB_ZSJM;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_zsjm);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_ZSJM = (LinearLayout) findViewById(R.id.LL_FB_ZSJM_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_ZSJM.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "6");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_ZSJM.addView(llitem_first);
