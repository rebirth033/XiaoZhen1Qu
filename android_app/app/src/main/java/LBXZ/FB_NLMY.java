...
public class FB_NLMY extends Base implements View.OnClickListener {

    private LinearLayout mllFB_NLMY;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fb_nlmy);
        findById();
        GetXL();
    }
    ...
    private void findById() {
        ...
        mllFB_NLMY = (LinearLayout) findViewById(R.id.LL_FB_NLMY_ROW);
    }
    ...
    public void YMTZ(String id) {
        if (id == "FB_Main") {
            Intent intent = new Intent(FB_NLMY.this, FB_Main.class);
        ...
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                ...
                try {
                    ...
                    NameValuePair LBID = new BasicNameValuePair("LBID", "1031");
    ...
    public void HandlerXL(String JList) {
        try {
            ...
            mllFB_NLMY.addView(llitem_first);
