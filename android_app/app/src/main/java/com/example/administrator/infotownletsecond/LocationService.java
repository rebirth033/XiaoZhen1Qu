...
public class LocationService {
    ...
    public LocationClientOption getDefaultLocationClientOption() {
        if (locationClientOption == null) {
            ...
            locationClientOption.setCoorType("bdll");//可选，默认gcj，设置返回的定位结果坐标系，如果配合百度地图使用，建议设置为bdll;
            locationClientOption.setScanSpan(0);//可选，默认0，即仅定位一次，设置发起定位请求的间隔需要大于等于ms才是有效的
