...
public class SY_ESC extends Base implements View.OnClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sy_esc);
        findById();
        GetCNXH();
    }
    ...
    public void YMTZ(String id) {
        if(id == "BACK") {
            Intent intent = new Intent(SY_ESC.this,SY_Main.class);
            finish();//关闭当前页面
        }
    }
    ...
    public void GetCNXH() {
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                Object result = null;
                String targeturl = "http://www.915fl.com/CLCX/LoadCLXXWithoutXZQ";
                try {
                    HttpPost httpRequest = new HttpPost(targeturl);
                    NameValuePair TYPE = new BasicNameValuePair("TYPE", "CLXX_JC");
