...
public class SY_MainActivity extends BaseActivity implements OnClickListener {
    ...
    //跳转登录页
    public void TZDLY() {
        Intent intent = new Intent(SY_MainActivity.this, YHDLActivity.class);
    ...
    public void YMTZ(String id) {
        if (id == "FB") {
            Intent intent = new Intent(SY_MainActivity.this, FBActivity.class);
            startActivity(intent);
            finish();//关闭当前页面
        }
        if (id == "XX") {
            Intent intent = new Intent(SY_MainActivity.this, XXActivity.class);
            startActivity(intent);
            finish();//关闭当前页面
        }
        if (id == "GRZX") {
            Intent intent = new Intent(SY_MainActivity.this, GRZX_MainActivity.class);
            startActivity(intent);
            finish();//关闭当前页面
        }
        if (id == "SY_ZF") {
            Intent intent = new Intent(SY_MainActivity.this, SY_ZFActivity.class);
            startActivity(intent);
        }
        if (id == "SY_ESF") {
            Intent intent = new Intent(SY_MainActivity.this, SY_ESFActivity.class);
            startActivity(intent);
        }
        if (id == "SY_CW") {
            Intent intent = new Intent(SY_MainActivity.this, SY_CWActivity.class);
            startActivity(intent);
        }
        if (id == "SY_SHFW") {
            Intent intent = new Intent(SY_MainActivity.this, SY_SHFWActivity.class);
            startActivity(intent);
        }
        if (id == "SY_SWFW") {
            Intent intent = new Intent(SY_MainActivity.this, SY_SWFWActivity.class);
            startActivity(intent);
        }
        if (id == "SY_ESWP") {
            Intent intent = new Intent(SY_MainActivity.this, SY_ESWPActivity.class);
            startActivity(intent);
        }
        if (id == "SY_ZP") {
            Intent intent = new Intent(SY_MainActivity.this, SY_ZPActivity.class);
            startActivity(intent);
        }
        if (id == "SY_JZ") {
            Intent intent = new Intent(SY_MainActivity.this, SY_JZActivity.class);
            startActivity(intent);
        }
        if (id == "SY_ESC") {
            Intent intent = new Intent(SY_MainActivity.this, SY_ESCActivity.class);
            startActivity(intent);
        }
        if (id == "SY_XC") {
            Intent intent = new Intent(SY_MainActivity.this, SY_XCActivity.class);
            startActivity(intent);
        }
    }
    ...
    //获取当前所在地
    public void HQDQSZD() {
        SY_MainActivity.context = getApplicationContext();
        LocationService.getInstance(SY_MainActivity.context).start();
        LocationService.getInstance(SY_MainActivity.context).registerListener(new MyLocationListener());// 注册监听函数
    }
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (null != location) {
                ...
                SY_MainActivity.context = getApplicationContext();
                LocationService.getInstance(SY_MainActivity.context).stop();
            } else {
                //tv_location.setText("\n定位失败");
            }
        }
