...
public class SY_ESWP extends Base implements View.OnClickListener {

    private ImageView mivBACK;
    private LinearLayout mllSBGG;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sy_eswp);
        findById();
        GetCNXH();
    }
    ...
    private void findById() {
        ...
        mllSBGG = (LinearLayout) findViewById(R.id.llSBGG);
    }
    ...
    public void YMTZ(String id) {
        if(id == "BACK") {
            Intent intent = new Intent(SY_ESWP.this,SY_Main.class);
            finish();//关闭当前页面
        }
    }
    ...
    public void GetCNXH() {
        new AsyncTask<String, Void, Object>() {
            ...
            protected Object doInBackground(String... params) {
                Object result = null;
                String targeturl = "http://www.915fl.com/ESCX/LoadESXXWithoutXZQ";
                try {
                    HttpPost httpRequest = new HttpPost(targeturl);
                    NameValuePair TYPE = new BasicNameValuePair("TYPE", "ESXX_SJSM_ESSJ");
