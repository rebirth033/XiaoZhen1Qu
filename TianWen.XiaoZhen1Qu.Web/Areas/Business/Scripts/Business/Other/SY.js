...
function OpenCXLB(lbid, typename, condition) {
    ...
    if (lbid === 124)
        window.open(getRootPath() + "/Business/CLCX/CLCX_ZC?LBID=" + lbid);
    if (lbid === 125)
        window.open(getRootPath() + "/Business/CLCX/CLCX_DJ?LBID=" + lbid);
    if (lbid === 119)
        window.open(getRootPath() + "/Business/CLCX/CLCX_JX?LBID=" + lbid);
    if (lbid === 120)
        window.open(getRootPath() + "/Business/CLCX/CLCX_QCPL?LBID=" + lbid);
    if (lbid === 121)
        window.open(getRootPath() + "/Business/CLCX/CLCX_QCWXBY?LBID=" + lbid);
    if (lbid === 122)
        window.open(getRootPath() + "/Business/CLCX/CLCX_GHSPNJYC?LBID=" + lbid);
    if (lbid === 123)
        window.open(getRootPath() + "/Business/CLCX/CLCX_QCMRZS?LBID=" + lbid);
    if (lbid === 126)
    ...
    if (lbid === 268)
        window.open(getRootPath() + "/Business/JYPXCX/JYPXCX_TYPXJG?LBID=" + lbid);
    if (lbid === 276)
    ...
    //生活服务
    if (lbid === 102)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_BJ?LBID=" + lbid);
    if (lbid === 103)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_BMYS?LBID=" + lbid);
    if (lbid === 104)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_BJQX?LBID=" + lbid);
    if (lbid === 107)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_GDSTQL?LBID=" + lbid);
    if (lbid === 108)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_SHPS?LBID=" + lbid);
    if (lbid === 106)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_KSXSHS?LBID=" + lbid);
    if (lbid === 111)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_BZMD?LBID=" + lbid);
    if (lbid === 112)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_JDWX?LBID=" + lbid);
    if (lbid === 113)
    ...
    if (lbid === 116)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_SJWX?LBID=" + lbid);
    if (lbid === 117)
        window.open(getRootPath() + "/Business/SHFWCX/SHFWCX_SMWX?LBID=" + lbid);
}