        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < (xml.list.length > 10 ? 10 : xml.list.length) ; i++) {
                    ...
                    html += "<li class='li_select' style='width:501px;' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITION + "' onclick='SelectHideSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITION + "\")'>" + xqmchtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < xml.list.length; i++) {
                    ...
                    html += "<li class='li_select' style='width:501px;' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITION + "' onclick='SelectHideSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITION + "\")'>" + SShtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
                $("#divHideSSJGlist").html(html);
                $("#divHideSSJGlist").css("display", "block");
