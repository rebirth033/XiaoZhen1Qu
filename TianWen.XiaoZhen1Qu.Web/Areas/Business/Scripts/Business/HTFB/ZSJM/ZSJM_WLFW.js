...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ZSJM/LoadZSJM_WLFWJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.ZSJM_WLFWJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.ZSJM_WLFWJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ZSJM/FBZSJM_WLFWJBXX",
        dataType: "json",
        data:
        {
