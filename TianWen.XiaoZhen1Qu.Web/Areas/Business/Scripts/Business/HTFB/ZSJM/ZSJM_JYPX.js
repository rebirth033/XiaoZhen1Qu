    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                $(".liJYPXXL").bind("click", function () { ValidateCheck("JYPXXL", "忘记选择小类啦"); });
                LoadZSDQ();
            }
        },
...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        if (type === "LB") {
            LoadCODESByTYPENAME("教育培训", "LB", "CODES_ZSJM", Bind, "JYPXLB", "LB", "");
        }
        if (type === "PPLS") {
            LoadCODESByTYPENAME("品牌历史", "PPLS", "CODES_ZSJM");
        }
        if (type === "TZJE") {
            LoadCODESByTYPENAME("投资金额", "TZJE", "CODES_ZSJM", Bind, "JYPXTZJE", "TZJE", "");
        }
        if (type === "QGFDS") {
...
function LoadZSJM_JYPXJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/ZSJM/LoadZSJM_JYPXJBXX",
        dataType: "json",
        data:
        {
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/ZSJM/FBZSJM_JYPXJBXX",
        dataType: "json",
        data:
        {
