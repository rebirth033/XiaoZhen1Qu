...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        ...
        if (type === "CZJLX") {
            LoadCODESByTYPENAME("出租间类型", "CZJLX", "CODES_FC", Bind, "CZJ", "CZJLX", "");
        }
        if (type === "CZJXB") {
            LoadCODESByTYPENAME("出租间性别", "CZJXB", "CODES_FC", Bind, "CZJ", "CZJXB", "");
        }
    });
}
//加载小区名称
...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/FC/LoadFC_HZFJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/FC/FBFC_HZFJBXX",
        dataType: "json",
        data:
        {
