...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/LoadPFCG_FSXMJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadXL(xml.Value.PFCG_FSXMJBXX.LB, xml.Value.PFCG_FSXMJBXX.XL);
                if (xml.Value.PFCG_FSXMJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.PFCG_FSXMJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/FBPFCG_FSXMJBXX",
        dataType: "json",
        data:
        {
