...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/LoadPFCG_AFSBJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadXL(xml.Value.PFCG_AFSBJBXX.LB, xml.Value.PFCG_AFSBJBXX.XL);
                if (xml.Value.PFCG_AFSBJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.PFCG_AFSBJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/FBPFCG_AFSBJBXX",
        dataType: "json",
        data:
        {
