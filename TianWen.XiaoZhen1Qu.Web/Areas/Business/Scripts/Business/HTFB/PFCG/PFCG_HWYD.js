...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG/LoadPFCG_HWYDJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.PFCG_HWYDJBXX.XL !== null)
                    SetDuoX("XL", xml.Value.PFCG_HWYDJBXX.XL);
                if (xml.Value.PFCG_HWYDJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.PFCG_HWYDJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG/FBPFCG_HWYDJBXX",
        dataType: "json",
        data:
        {
