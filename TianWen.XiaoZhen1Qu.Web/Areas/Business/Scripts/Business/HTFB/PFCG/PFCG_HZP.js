...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG/LoadPFCG_HZPJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.PFCG_HZPJBXX.XL !== null)
                    SetDuoX("XL", xml.Value.PFCG_HZPJBXX.XL);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG/FBPFCG_HZPJBXX",
        dataType: "json",
        data:
        {
