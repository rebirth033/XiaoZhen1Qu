    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (parseInt(xml.list.length % 6) === 0)
                    $("#divXL").css("height", parseInt(xml.list.length / 6) * 40 + "px");
                else
                    $("#divXL").css("height", (parseInt(xml.list.length / 6) + 1) * 40 + "px");
                html += "</ul>";
                $("#divXLText").html(html);
...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/LoadPFCG_DJZMJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadXL(xml.Value.PFCG_DJZMJBXX.LB, xml.Value.PFCG_DJZMJBXX.XL);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/FBPFCG_DJZMJBXX",
        dataType: "json",
        data:
        {
