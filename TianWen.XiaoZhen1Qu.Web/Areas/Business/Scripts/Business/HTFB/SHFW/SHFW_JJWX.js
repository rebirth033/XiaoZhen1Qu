...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/LoadSHFW_JJWXJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.SHFW_JJWXJBXX.LB !== null)
                    SetDuoX("LB", xml.Value.SHFW_JJWXJBXX.LB);
                if (xml.Value.SHFW_JJWXJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.SHFW_JJWXJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/FBSHFW_JJWXJBXX",
        dataType: "json",
        data:
        {
