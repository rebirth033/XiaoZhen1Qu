...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/LoadSHFW_BJJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.SHFW_BJJBXX.LB !== null)
                    SetDuoX("LB", xml.Value.SHFW_BJJBXX.LB);
                if (xml.Value.SHFW_BJJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.SHFW_BJJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/FBSHFW_BJJBXX",
        dataType: "json",
        data:
        {
