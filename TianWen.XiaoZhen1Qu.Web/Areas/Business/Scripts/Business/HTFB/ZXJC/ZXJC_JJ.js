...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ZXJC/LoadZXJC_JJJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.ZXJC_JJJBXX.LB !== null)
                    SetDuoX("LB", xml.Value.ZXJC_JJJBXX.LB);
                if (xml.Value.ZXJC_JJJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.ZXJC_JJJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ZXJC/FBZXJC_JJJBXX",
        dataType: "json",
        data:
        {
