...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ES/LoadES_MYFZMR_MYETYPWJJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.ES_MYFZMR_MYETYPWJJBXX.PSFS !== null)
                    SetDuoX("PSFS", xml.Value.ES_MYFZMR_MYETYPWJJBXX.PSFS);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ES/FBES_MYFZMR_MYETYPWJJBXX",
        dataType: "json",
        data:
        {
