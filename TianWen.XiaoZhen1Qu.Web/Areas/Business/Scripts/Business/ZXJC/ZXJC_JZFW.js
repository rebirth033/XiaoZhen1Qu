...
$(document).ready(function () {$("body").bind("click", function () { Close("_XZQ"); Close("CX"); Close("PP"); Close("CCNX"); Close("CCYF"); Close("QY"); Close("DD"); });LoadZXJC_JZFWJBXX();
    BindClick("LB");
    BindClick("QY");
    BindClick("DD");
});
...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        if (type === "LB") {
            LoadCODESByTYPENAME("家装服务", "LB", "CODES_ZXJC");
        }
        if (type === "XL") {
            LoadXL();
        }
...
function LoadZXJC_JZFWJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/ZXJC_JZFW/LoadZXJC_JZFWJBXX",
        dataType: "json",
        data:
        {
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/ZXJC_JZFW/FB",
        dataType: "json",
        data:
        {
