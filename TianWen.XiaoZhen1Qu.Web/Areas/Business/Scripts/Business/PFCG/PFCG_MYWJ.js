...
$(document).ready(function () {$("body").bind("click", function () { Close("_XZQ"); Close("CX"); Close("PP"); Close("CCNX"); Close("CCYF"); Close("QY"); Close("DD"); });LoadPFCG_MYWJJBXX();
...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        if (type === "LB") {
            LoadCODESByTYPENAME("母婴玩具", "LB", "CODES_PFCG");
        }
        if (type === "XL") {
            LoadXL();
        }
...
function LoadPFCG_MYWJJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG_MYWJ/LoadPFCG_MYWJJBXX",
        dataType: "json",
        data:
        {
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/PFCG_MYWJ/FB",
        dataType: "json",
        data:
        {
