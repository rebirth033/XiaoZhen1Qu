    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                $("#spanDSPMCC").html(xml.Value.ES_QTES_ESSBJBXX.DSPMCC);
                $("#spanDSPP").html(xml.Value.ES_QTES_ESSBJBXX.DSPP);
                $("#spanXYJPP").html(xml.Value.ES_QTES_ESSBJBXX.XYJPP);
                $("#spanKTPP").html(xml.Value.ES_QTES_ESSBJBXX.KTPP);
                $("#spanKTBPDS").html(xml.Value.ES_QTES_ESSBJBXX.KTBPDS);
                $("#spanKTGL").html(xml.Value.ES_QTES_ESSBJBXX.KTGL);
                $("#spanBXPP").html(xml.Value.ES_QTES_ESSBJBXX.BXPP);
                $("#spanBGPP").html(xml.Value.ES_QTES_ESSBJBXX.BGPP);
