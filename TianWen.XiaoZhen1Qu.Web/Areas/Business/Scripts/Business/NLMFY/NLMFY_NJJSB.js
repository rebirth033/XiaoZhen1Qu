...
function LoadNLMFY_NJJSBJBXX() {
    $.ajax({
        ...
        data:
        {
            NLMFY_NJJSBJBXXID: getUrlParam("NLMFY_NJJSBJBXXID")
        },
        success: function (xml) {
            if (xml.Result === 1) {
                var jsonObj = new JsonDB("myTabContent");
                jsonObj.DisplayFromJson("myTabContent", xml.Value.NLMFY_NJJSBJBXX);
                jsonObj.DisplayFromJson("myTabContent", xml.Value.JCXX);
                $("#NLMFY_NJJSBJBXXID").val(xml.Value.NLMFY_NJJSBJBXX.NLMFY_NJJSBJBXXID);
                //设置编辑器的内容
                ue.ready(function () {
                    ue.setHeight(200);
                    ue.setContent(xml.Value.NLMFY_NJJSBJBXX.BCMS);
                });
                $("#spanLB").html(xml.Value.NLMFY_NJJSBJBXX.LB);
                $("#spanXL").html(xml.Value.NLMFY_NJJSBJBXX.XL);
                $("#spanQY").html(xml.Value.NLMFY_NJJSBJBXX.QY);
                $("#spanDD").html(xml.Value.NLMFY_NJJSBJBXX.DD);
...
function FB() {
    ...
    if (getUrlParam("NLMFY_NJJSBJBXXID") !== null)
        obj = jsonObj.AddJson(obj, "NLMFY_NJJSBJBXXID", "'" + getUrlParam("NLMFY_NJJSBJBXXID") + "'");
