...
$(document).ready(function () {$("body").bind("click", function () { Close("_XZQ"); Close("CX"); Close("PP"); Close("CCNX"); Close("CCYF"); Close("QY"); Close("DD"); });BindClick("LX");
    BindClick("QY");
    BindClick("DD");
    LoadHQSY_HQYPJBXX();
});
...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        if (type === "LX") {
            LoadCODESByTYPENAME("婚庆用品", "LX", "CODES_HQSY");
        }
        if (type === "XL") {
            LoadXL();
        }
...
function LoadHQSY_HQYPJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/HQSY_HQYP/LoadHQSY_HQYPJBXX",
        dataType: "json",
        data:
        {
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/HQSY_HQYP/FB",
        dataType: "json",
        data:
        {
