...
function LoadHeadSearch() {
    $(".div_head_right_ss").append('<span class="span_head_right_ss" onclick="OpenCXLB(197,\'/CLCX/CLCX_QCWXBY\',\'null\')">工商注册</span>');
...
function LoadSWFWTOP() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SY/LoadSWFWTOP",
        dataType: "json",
        data:
        {
