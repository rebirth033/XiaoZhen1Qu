...
function BindClick(type) {
    $("#div" + type + "Span").click(function () {
        if (type === "LB") {
            LoadCODESByTYPENAME("学历教育", "LB", "CODES_JYPX");
        }
        if (type === "QY") {
            LoadQY();
        }
...
function LoadJYPX_XLJYJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/JYPX_XLJY/LoadJYPX_XLJYJBXX",
        dataType: "json",
        data:
        {
            JYPX_XLJYJBXXID: getUrlParam("JYPX_XLJYJBXXID")
        },
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                $("#JYPX_XLJYJBXXID").val(xml.Value.JYPX_XLJYJBXX.JYPX_XLJYJBXXID);
                //设置编辑器的内容
                ue.ready(function () {
                    ue.setHeight(200);
                    ue.setContent(xml.Value.JYPX_XLJYJBXX.BCMS);
                });
...
function FB() {
    ...
    if (getUrlParam("JYPX_XLJYJBXXID") !== null)
        obj = jsonObj.AddJson(obj, "JYPX_XLJYJBXXID", "'" + getUrlParam("JYPX_XLJYJBXXID") + "'");

    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/JYPX_XLJY/FB",
        dataType: "json",
        data:
        {
