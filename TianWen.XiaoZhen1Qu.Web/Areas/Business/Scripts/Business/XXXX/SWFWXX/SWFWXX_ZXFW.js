    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("SWFWXX_ZXFW");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("SWFWXX_ZXFW");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'SWFWXX_ZXFW\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'SWFWXX_ZXFW\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'SWFWXX_ZXFW\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
