...
function LoadDefault() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/XXYLXX/LoadXXYLXX",
        dataType: "json",
        data:
        {
            TYPE: "XXYLXX_DIYSGF",
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("XXYLXX_DIYSGF");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("XXYLXX_DIYSGF");
            }
        },
...
function LoadCNXH(TYPE) {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/XXYLCX/LoadXXYLXX",
        dataType: "json",
        data:
        {
            TYPE: TYPE,
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_DIYSGF\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_DIYSGF\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_DIYSGF\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
