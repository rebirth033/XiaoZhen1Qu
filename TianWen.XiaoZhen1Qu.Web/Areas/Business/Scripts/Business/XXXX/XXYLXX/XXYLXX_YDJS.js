    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("XXYLXX_YDJS");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("XXYLXX_YDJS");
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_YDJS\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_YDJS\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'XXYLXX_YDJS\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
