    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("JYPXXX_YYEJY");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("JYPXXX_YYEJY");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">服务类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.FWLX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">办学性质：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.BXXZ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">营业时间：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.YYKSSJ_H + ":" + obj.YYKSSJ_M + " 到 " + obj.YYJSSJ_H + ":" + obj.YYJSSJ_M + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_YYEJY\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_YYEJY\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_YYEJY\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
