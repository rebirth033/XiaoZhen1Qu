...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">语种：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.YZ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">专项：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.ZX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">级别：</span>');
