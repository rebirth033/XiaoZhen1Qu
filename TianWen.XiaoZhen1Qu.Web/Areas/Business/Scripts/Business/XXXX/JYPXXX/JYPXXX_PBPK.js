    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("JYPXXX_PBPK");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("JYPXXX_PBPK");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">辅导科目：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.FDKM + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">辅导阶段：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.FDJD + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">拼班人数：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.PBRS + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">场&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.CD + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_PBPK\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_PBPK\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_PBPK\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
