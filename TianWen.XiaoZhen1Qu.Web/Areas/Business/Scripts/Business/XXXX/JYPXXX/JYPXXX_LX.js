...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">申请学历：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SQXL + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">国&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.GJ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_LX\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_LX\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_LX\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
