    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("JYPXXX_JJJG");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("JYPXXX_JJJG");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_JJJG\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_JJJG\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'JYPXXX_JJJG\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
