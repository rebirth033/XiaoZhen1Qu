    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("CLXX_QCMRZS");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("CLXX_QCMRZS");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCMRZS\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCMRZS\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCMRZS\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CLCX/CLCX_QCMRZS?LBID=13" + "&" + TYPE + "=" + ID);
}