    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("CLXX_QCWXBY");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("CLXX_QCWXBY");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCWXBY\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCWXBY\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_QCWXBY\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_cs">' + ValidateNull(obj.QY) + ' - ' + ValidateNull(obj.DD) + '平</p>');
    html += ('</div>');
    html += ('</li>');
    return html;
}
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CLCX/CLCX_QCWXBY?LBID=13" + "&" + TYPE + "=" + ID);
}