...
function LoadCNXHInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_cnxh_xq">' + TruncStr(obj.BT, 12) + '</p>');
...
function LoadJPTJInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_jptj_xq">' + TruncStr(obj.BT, 12) + '</p>');
...
function LoadJJRTJFYInfo(obj) {
    ...
    html += ('<p class="p_li_body_right_jjrtj_xq">' + TruncStr(obj.BT, 12) + '</p>');
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.QY + '-' + obj.DD + '平</p>');
