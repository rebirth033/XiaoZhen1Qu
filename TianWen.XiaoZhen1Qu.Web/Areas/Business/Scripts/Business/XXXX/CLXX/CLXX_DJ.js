...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_DJ\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
    ...
    html += ('<p class="p_li_body_left_body_cnxh_cs">' + obj.LB + '</p>');
    html += ('</li>');
    return html;
}
//加载精品推荐
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_DJ\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
    ...
    html += ('<p class="p_li_body_left_body_jptj_cs">' + obj.LB + '</p>');
    html += ('</li>');
    return html;
}
//加载该经纪人推荐
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_DJ\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.LB + '</p>');
    html += ('</div>');
    html += ('</li>');
    return html;
}
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CLCX/CLCX_DJ?LBID=13" + "&" + TYPE + "=" + ID);
}