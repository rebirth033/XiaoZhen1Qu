...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">出厂时间：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.CCNF + obj.CCYF + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">小&nbsp;&nbsp;时&nbsp;&nbsp;数：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.XSS + '小时</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">吨&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.DW + '吨</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_cnxh_cs">' + obj.CX + ' / ' + obj.CCNF + ' / ' + obj.XSS + '小时' + '</p>');
...
function LoadJPTJInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_jptj_cs">' + obj.CX + ' / ' + obj.CCNF + ' / ' + obj.XSS + '小时' + '</p>');
...
function LoadJJRTJFYInfo(obj) {
    ...
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.CX + ' / ' + obj.CCNF + ' / ' + obj.XSS + '小时' + '</p>');
