...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_right">' + obj.XL + '小时</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_ZC\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
    ...
    html += ('<p class="p_li_body_left_body_cnxh_xq">' + obj.LB + ' / ' + obj.XL + '</p>');
    html += ('<p class="p_li_body_left_body_cnxh_cs">' + obj.QY + '-' + obj.DD + '</p>');
    html += ('<p class="p_li_body_left_body_cnxh_jg">' + obj.ZXGXSJ.ToString("MM月dd日") + '</p>');
    html += ('</li>');
    return html;
}
//加载精品推荐
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_ZC\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_xq">' + obj.LB + ' / ' + obj.XL + '</p>');
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.QY + '-' + obj.DD + '</p>');
    html += ('<p class="p_li_body_right_jjrtj_jg">' + obj.ZXGXSJ.ToString("MM月dd日") + '</p>');
    html += ('</div>');
    html += ('</li>');
    return html;
}
