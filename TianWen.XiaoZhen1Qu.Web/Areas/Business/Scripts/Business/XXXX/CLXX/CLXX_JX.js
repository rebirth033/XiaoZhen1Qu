...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">驾照类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.JZ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">驾校名称：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.JXMC + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">班&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.BB + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadXQ(obj, BCMSString) {
    ...
    html += ('<p class="p_body_left_body_xq">详情</p>');
    html += ('<div class="div_body_left_body_xq_xx">');
    html += ('<div class="div_body_left_body_xq_xx_left">驾校描述</div>');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_JX\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_JX\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_JX\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CLCX/CLCX_JX?LBID=13" + "&" + TYPE + "=" + ID);
}