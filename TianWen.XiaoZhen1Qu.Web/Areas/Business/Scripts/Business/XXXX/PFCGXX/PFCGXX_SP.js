...
function LoadCNXHInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_cnxh_jg">' + obj.QY + '-' + obj.DD + '</p>');
    html += ('</li>');
    return html;
}
//加载精品推荐
...
function LoadJPTJInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_body_jptj_jg">' + obj.QY + '-' + obj.DD + '</p>');
    html += ('</li>');
    return html;
}
//加载该经纪人推荐
...
function LoadJJRTJFYInfo(obj) {
    ...
    html += ('<p class="p_li_body_right_jjrtj_jg">' + obj.QY + '-' + obj.DD + '</p>');
    html += ('</div>');
    html += ('</li>');
    return html;
}
