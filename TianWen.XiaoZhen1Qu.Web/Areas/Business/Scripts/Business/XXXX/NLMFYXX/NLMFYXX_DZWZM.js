...
function LoadDefault() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/NLMFYXX/LoadNLMFYXX",
        dataType: "json",
        data:
        {
            TYPE: "NLMFYXX_DZWZM",
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("NLMFYXX_DZWZM");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("NLMFYXX_DZWZM");
                HandlerTPXX();
            }
        },
...
function LoadCNXH(TYPE) {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/NLMFYCX/LoadNLMFYXX",
        dataType: "json",
        data:
        {
            TYPE: TYPE,
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_DZWZM\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_DZWZM\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_DZWZM\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
