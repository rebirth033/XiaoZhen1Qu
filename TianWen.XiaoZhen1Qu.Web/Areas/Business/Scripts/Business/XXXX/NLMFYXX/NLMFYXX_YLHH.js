    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("NLMFYXX_YLHH");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("NLMFYXX_YLHH");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_YLHH\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_YLHH\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_YLHH\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
