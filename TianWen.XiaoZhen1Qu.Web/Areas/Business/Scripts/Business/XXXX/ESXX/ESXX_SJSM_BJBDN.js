...
function LoadDefault() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/ESXX/LoadESXX",
        dataType: "json",
        data:
        {
            TYPE: "ESXX_SJSM_BJBDN",
            ID: getUrlParam("ID")
        },
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("ESXX_SJSM_BJBDN");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("ESXX_SJSM_BJBDN");
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_right">' + obj.BJBPP + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">型号：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.BJBXH + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">内存：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.NC + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">硬盘：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.YP + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">屏幕尺寸：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.PMCC + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_SJSM_BJBDN\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
    ...
    html += ('<p class="p_li_body_left_body_cnxh_xq">' + TruncStr(obj.BT,23) + '</p>');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_SJSM_BJBDN\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
    ...
    html += ('<p class="p_li_body_left_body_jptj_xq">' + TruncStr(obj.BT,23) + '</p>');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_SJSM_BJBDN\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_xq">' + TruncStr(obj.BT,23) + '</p>');
