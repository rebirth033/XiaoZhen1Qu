    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("ESCX_PWKQ_YLYJDP");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("ESCX_PWKQ_YLYJDP");
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESCX_PWKQ_YLYJDP\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESCX_PWKQ_YLYJDP\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESCX_PWKQ_YLYJDP\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
