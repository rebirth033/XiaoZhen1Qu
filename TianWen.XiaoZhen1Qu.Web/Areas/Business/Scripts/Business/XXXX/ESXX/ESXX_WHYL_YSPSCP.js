    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("ESXX_WHYL_YSPSCP");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("ESXX_WHYL_YSPSCP");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_WHYL_YSPSCP\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_WHYL_YSPSCP\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_WHYL_YSPSCP\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/ESCX/ESCX_WHYL_YSPSCP?LBID=13" + "&" + TYPE + "=" + ID);
}