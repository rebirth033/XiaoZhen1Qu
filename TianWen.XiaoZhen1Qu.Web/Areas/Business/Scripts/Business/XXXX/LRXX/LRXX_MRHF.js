...
function LoadDefault() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/LRXX/LoadLRXX",
        dataType: "json",
        data:
        {
            TYPE: "LRXX_MRHF",
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LRXX_MRHF\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LRXX_MRHF\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LRXX_MRHF\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
