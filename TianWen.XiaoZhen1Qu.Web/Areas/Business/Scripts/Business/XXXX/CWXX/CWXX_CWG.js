...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWG\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
    ...
    html += ('<p class="p_li_body_left_body_cnxh_cs">' + obj.PZ + ' / ' + obj.NL + obj.NLDW + '</p>');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWG\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
    ...
    html += ('<p class="p_li_body_left_body_jptj_cs">' + obj.PZ + ' / ' + obj.NL + obj.NLDW + '</p>');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWG\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.PZ + ' / ' + obj.NL + obj.NLDW + '</p>');
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CWCX/CWCX_CWG?LBID=13" + "&" + TYPE + "=" + ID);
}