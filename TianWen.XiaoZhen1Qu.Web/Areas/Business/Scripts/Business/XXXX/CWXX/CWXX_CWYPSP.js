    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("CWXX_CWYPSP");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("CWXX_CWYPSP");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">新&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;旧：</span>');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWYPSP\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWYPSP\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CWXX_CWYPSP\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
...
function OpenSS(TYPE, ID) {
    window.open(getRootPath() + "/CWCX/CWCX_CWYPSP?LBID=13" + "&" + TYPE + "=" + ID);
}