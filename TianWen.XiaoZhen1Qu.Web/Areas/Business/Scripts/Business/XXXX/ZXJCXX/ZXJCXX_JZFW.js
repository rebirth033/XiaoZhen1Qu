    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("ZXJCXX_JZFW");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("ZXJCXX_JZFW");
                HandlerTPXX();
            }
        },
...
function LoadXQ(obj, BCMSString) {
    ...
    html += ('<div id="div_body_left_body_xq_xx_bcms" class="div_body_left_body_xq_xx div_body_left_body_xq_xx_bcms">');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ZXJCXX_JZFW\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ZXJCXX_JZFW\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ZXJCXX_JZFW\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
