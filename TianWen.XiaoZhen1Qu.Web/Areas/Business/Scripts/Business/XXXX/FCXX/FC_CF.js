...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_right">' + obj.QY + '-' + obj.SQ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">地段：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.DD + '</span>');
    html += ('</p>');
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FC_CF\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FC_CF\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FC_CF\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
