...
function LoadJBXX(obj) {
    ...
    for (var i = 0; i < obj.PHOTOS.length; i++) {
        ...
        html += ('<img class="img_body_left_body_left_list_tp" onclick="ImgShow(this)" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[i].PHOTONAME + "?j=" + Math.random() + '" />');
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">写字楼名称：</span>');
