    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("FCXX_XZL", xml.list[0].GQ);
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("FCXX_XZL", xml.list[0].GQ);
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">名称：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.LPMC + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">可注册公司：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.KZCGS + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
...
function LoadCNXHInfo(obj, GQ) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FCXX_XZL\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
    ...
    html += ('<p class="p_li_body_left_body_cnxh_cs">' + obj.XZLLX + ' / ' + obj.MJ + '平米</p>');
...
function LoadJPTJInfo(obj, GQ) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FCXX_XZL\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
    ...
    html += ('<p class="p_li_body_left_body_jptj_cs">' + obj.XZLLX + ' / ' + obj.MJ + '平米</p>');
...
function LoadJJRTJFYInfo(obj, GQ) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'FCXX_XZL\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
    ...
    html += ('<p class="p_li_body_right_jjrtj_cs">' + obj.XZLLX + ' / ' + obj.MJ + '平米</p>');
