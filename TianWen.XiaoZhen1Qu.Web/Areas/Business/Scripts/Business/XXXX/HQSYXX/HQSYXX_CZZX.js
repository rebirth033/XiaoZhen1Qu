    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("HQSYXX_CZZX");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("HQSYXX_CZZX");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">化妆类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.HZLX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">服务形式：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.FWXS + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
