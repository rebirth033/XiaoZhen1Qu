    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("HQSYXX_HYJD");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("HQSYXX_HYJD");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">婚礼类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.HLLX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">酒店类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.JDLX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">酒店星级：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.JDXJ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">容纳桌数：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.RNZS + '桌</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
