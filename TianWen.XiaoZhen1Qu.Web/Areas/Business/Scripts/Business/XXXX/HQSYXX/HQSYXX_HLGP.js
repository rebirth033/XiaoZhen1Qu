...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">摄影师人数：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SYSRS + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">跟拍时间：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.GPSJ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">摄录器材：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SLQC + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">摄录成品：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SLCP + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
