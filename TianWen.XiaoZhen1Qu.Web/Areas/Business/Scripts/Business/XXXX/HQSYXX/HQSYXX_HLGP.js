    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("HQSYXX_HLGP");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("HQSYXX_HLGP");
                HandlerTPXX();
            }
        },
...
function LoadJBXX(obj) {
    ...
    html += ('<span class="span_body_left_body_right_left">跟拍类型：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.GPLX + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left" style="width:100px !important;margin-left:-10px;">摄影师人数：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SYSRS + '人</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">跟拍时间：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.GPSJ + '小时</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">摄录器材：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SLQC + '套</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">摄录成品：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.SLCP + '件</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
