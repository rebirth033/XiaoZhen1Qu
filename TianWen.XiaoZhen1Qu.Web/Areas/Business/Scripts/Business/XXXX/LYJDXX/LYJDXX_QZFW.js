    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("LYJDXX_QZFW");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("LYJDXX_QZFW");
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_QZFW\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_QZFW\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_QZFW\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
