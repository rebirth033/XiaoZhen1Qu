    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadCNXH("LYJDXX_JDZSYD");
                LoadGRXX(xml.grxxlist[0]);
                LoadJJRTJFY("LYJDXX_JDZSYD");
                HandlerTPXX();
            }
        },
...
function LoadCNXHInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_JDZSYD\',\'' + obj.ID + '\')" class="li_body_left_body_cnxh">');
...
function LoadJPTJInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_JDZSYD\',\'' + obj.ID + '\')" class="li_body_left_body_jptj">');
...
function LoadJJRTJFYInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'LYJDXX_JDZSYD\',\'' + obj.ID + '\')" class="li_body_right_jjrtj">');
