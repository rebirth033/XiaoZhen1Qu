...
function LoadESCondition() {
    ...
    LoadBody("ESCX_PWKQ_QTKQ", currentIndex);
}
//选择条件
function SelectCondition(obj, name) {
    ...
    LoadBody("ESCX_PWKQ_QTKQ", currentIndex);
    ShowSelectCondition("ESCX_PWKQ_QTKQ");
}
//加载主体部分
...
function LoadESInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'ESCX_PWKQ_QTKQ\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
