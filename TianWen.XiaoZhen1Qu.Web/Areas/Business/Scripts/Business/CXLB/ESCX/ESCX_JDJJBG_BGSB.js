...
function LoadESCondition() {
    LoadConditionByTypeNames("'办公用品/设备类别','电视价格'", "CODES_ES_JDJJBG", "类别,价格", "LB,JG", "100,100");
}
//加载URL查询条件
...
function SelectCondition(obj, name) {
    if (name === "类别" && (obj.innerHTML !== "其他办公用品" && obj.innerHTML !== "公司转让")) {
    ...
    LoadBody("ESXX_JDJJBG_BGSB", currentIndex);
    ShowSelectCondition("ESXX_JDJJBG_BGSB");
}
//选择URL条件
...
function LoadInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_JDJJBG_BGSB\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
