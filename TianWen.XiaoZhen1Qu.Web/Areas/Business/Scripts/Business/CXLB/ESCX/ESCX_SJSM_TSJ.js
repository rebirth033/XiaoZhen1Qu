...
function LoadBody(TYPE, PageIndex) {
    ...
    var condition = GetAllCondition("LB,XL,CPUPP,JG,QY,SF");
    $.ajax({
        type: "POST",
...
function LoadInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_SJSM_TSJ\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
