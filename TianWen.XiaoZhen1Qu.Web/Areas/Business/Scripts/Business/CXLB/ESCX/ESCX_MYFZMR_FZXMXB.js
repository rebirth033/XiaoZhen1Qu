...
function LoadESCondition() {
    ...
    var lb = "类别,不限,服装,鞋帽".split(',');
    var xl = "小类,不限,休闲鞋,运动鞋,帆布鞋,高跟鞋,板鞋,皮鞋,靴子,凉鞋,拖鞋,婚鞋,登山鞋".split(',');
    var jg = "价格,不限,20元以下,20-50元,50-100元,100-150元,150-300元,300-500元,500-1000元,1000-2000元,2000元以上".split(',');
...
function LoadESInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_MYFZMR_FZXMXB\',\'' + obj.ID + '\')">' + TruncStr(obj.BT,35) + '</p>');
