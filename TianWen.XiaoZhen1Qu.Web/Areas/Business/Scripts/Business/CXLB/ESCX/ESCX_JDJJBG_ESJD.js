...
$(document).ready(function () {
    BindBodyNav();
    LoadESCondition();
    LoadHot("ESXX_JDJJBG_ESJD");
});
//加载条件
function LoadESCondition() {
    LoadConditionByTypeNames("'二手家电类别','电视价格'", "CODES_ES_JDJJBG", "类别,价格", "LB,JG", "100,100");
}
//加载URL查询条件
...
function SelectCondition(obj, name) {
    ...
    LoadBody("ESXX_JDJJBG_ESJD", currentIndex);
    ShowSelectCondition("ESXX_JDJJBG_ESJD");
}
//选择URL条件
...
function LoadBody(TYPE, PageIndex) {
    ...
    var condition = GetAllCondition("LB,XL,PP,JG,QY,SF");
    $.ajax({
        type: "POST",
