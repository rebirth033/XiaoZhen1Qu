...
function LoadInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_SJSM_SMCP\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
...
function LoadHotInfo(obj) {
    ...
    html += ('<p class="p_li_body_right_xq" style="height:20px;">' + obj.BT + '</p>');
