...
function LoadESCondition() {
    ...
    var lb = "类别,不限,床,床垫,柜子,架子,桌子,椅子/凳,沙发,茶几,办公桌椅,家具回收".split(',');
...
function LoadESInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_JDJJBG_JJRY\',\'' + obj.ID + '\')">' + TruncStr(obj.BT,35) + '</p>');
