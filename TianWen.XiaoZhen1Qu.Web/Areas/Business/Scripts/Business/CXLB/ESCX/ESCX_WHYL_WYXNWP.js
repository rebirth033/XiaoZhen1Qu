...
function LoadESCondition() {
    LoadConditionByTypeName("网游/虚拟物品", "CODES_ES_WHYL", "类别", "LB");
    LoadConditionByTypeName("游戏", "CODES_ES_WHYL", "游戏", "XL",15);
...
function LoadESInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'ESXX_WHYL_WYXNWP\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
    html += ('<div class="div_img_li_body_left_count"><span>' + obj.PHOTOS.length + '图</span></div>');
    html += ('</div>');
    html += ('<div class="div_li_body_left_center">');
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_WHYL_WYXNWP\',\'' + obj.ID + '\')">' + TruncStr(obj.BT,35) + '</p>');
