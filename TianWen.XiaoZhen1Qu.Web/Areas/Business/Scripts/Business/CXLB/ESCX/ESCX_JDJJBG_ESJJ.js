...
function LoadESCondition() {
    ...
    var lb = "类别,不限,床上用品,布艺饰品,生活日用,灯具照明,厨房卫浴".split(',');
    var xl = "小类,不限,相框,地毯,地垫,挂毯,抱枕/靠垫,坐垫/沙发垫,窗帘/窗纱".split(',');
...
function LoadESInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_JDJJBG_ESJJ\',\'' + obj.ID + '\')">' + TruncStr(obj.BT,35) + '</p>');
