...
function LoadESCondition() {
    LoadConditionByTypeNames("'演出门票类别','卡券价格'", "CODES_ES_PWKQ", "类别,价格", "LB,JG", "13,15");
...
function LoadInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_PWKQ_YCMP\',\'' + obj.ID + '\')">' + TruncStr(obj.BT, 35) + '</p>');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ESXX_PWKQ_YCMP\',\'' + obj.ID + '\')" class="li_body_right">');
