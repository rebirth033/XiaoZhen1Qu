...
function LoadCLCondition() {
    LoadConditionByTypeNames("'租车'", "CODES_CL", "类别", "LB", "15");
...
//加载单条信息
function LoadCL_ZCInfo(obj) {
    var html = "";
    html += ('<li class="li_body_left" onclick="OpenXXXX(\'CLXX_ZC\',\'' + obj.ID + '\')">');
    ...
    html += ('<p class="p_li_body_left_center_cs font_size16">' + obj.QY + '-' + obj.DD + '-' + obj.JTDZ + '</p>');
