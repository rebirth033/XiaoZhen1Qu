...
function LoadCLCondition() {
    LoadConditionByTypeNames("'客车品牌','客车价格'", "CODES_CL", "品牌,价格", "PP,JG","15,15");
...
function LoadCL_JCInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'CLXX_KC\',\'' + obj.ID + '\')">' + TruncStr(obj.BT, 35) + '</p>');
