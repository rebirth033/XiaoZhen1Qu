...
function LoadCL_SLCInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'CLXX_SLC\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
    html += ('<p class="p_li_body_left_center_cs">' + obj.CX + ' / ' + obj.XJ + ' / ' + ValidateNull(obj.QY) + ' - ' + ValidateNull(obj.DD) + '</p>');
