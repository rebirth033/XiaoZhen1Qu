...
function SelectCondition(obj, name) {
    ...
    LoadBody("CLXX_GHSPNJYC", currentIndex);
    ShowSelectCondition("CLXX_GHSPNJYC");
}
//选择URL条件
...
function LoadInfo(obj) {
    ...
    if (obj.PHOTOS.length > 0) {
        html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'CLXX_GHSPNJYC\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'CLXX_GHSPNJYC\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'CLXX_GHSPNJYC\',\'' + obj.ID + '\')" class="li_body_right">');
    if (obj.PHOTOS.length > 0) {
        html += ('<img class="img_li_body_right" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
    } else {
        html += ('<img class="img_li_body_right" src="' + getRootPath() + "/Areas/Business/Css/images/HTGL/no_image.png?j=" + Math.random() + '" />');
    }
