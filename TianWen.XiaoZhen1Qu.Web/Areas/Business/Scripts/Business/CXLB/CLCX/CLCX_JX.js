...
function LoadCLCondition() {
    LoadConditionByTypeName("驾校类别", "CODES_CL", "类别", "LB");
    LoadConditionByTypeName("驾照", "CODES_CL", "驾照", "JZ", 9);
    LoadConditionByTypeName("班别", "CODES_CL", "班别", "BB");
...
function LoadCL_JCInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'CLXX_JX\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
    html += ('<div class="div_img_li_body_left_count"><span>' + obj.PHOTOS.length + '图</span></div>');
    html += ('</div>');
    html += ('<div class="div_li_body_left_center">');
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'CLXX_JX\',\'' + obj.ID + '\')">' + TruncStr(obj.BT, 35) + '</p>');
