...
function LoadZXJCCondition() {
    LoadConditionByTypeName("建材", "CODES_ZXJC", "类别", "LB",15);
    LoadDistrict("福州", "350100", "QY");
    LoadBody("ZXJCXX_JC", currentIndex);
}
//选择条件
...
function LoadQZZPInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'ZXJCXX_JC\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
