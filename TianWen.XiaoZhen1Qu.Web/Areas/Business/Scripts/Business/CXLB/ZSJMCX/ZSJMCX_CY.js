...
function LoadZSJMCondition() {
    LoadConditionByTypeNames("'餐饮类别','投资金额'", "CODES_ZSJM", "类别,投资金额", "LB,TZJE", "100,100");
}
//加载URL查询条件
...
function LoadInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'ZSJMXX_CY\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ZSJMXX_CY\',\'' + obj.ID + '\')" class="li_body_right">');
