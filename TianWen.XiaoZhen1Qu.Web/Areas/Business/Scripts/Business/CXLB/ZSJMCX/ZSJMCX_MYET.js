...
function LoadZSJMCondition() {
    LoadConditionByTypeNames("'文体/母婴/儿童类别','投资金额'", "CODES_ZSJM", "类别,投资金额", "LB,TZJE", "15,15");
...
function LoadInfo(obj) {
    var html = "";
    html += ('<li class="li_body_left" onclick="OpenXXXX(\'ZSJMXX_MYET\',\'' + obj.ID + '\')">');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'ZSJMXX_MYET\',\'' + obj.ID + '\')" class="li_body_right">');
