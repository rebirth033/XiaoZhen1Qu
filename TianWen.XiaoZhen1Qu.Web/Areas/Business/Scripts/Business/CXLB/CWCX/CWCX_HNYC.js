...
function LoadCWCondition() {
    ...
    var pz = "品种,不限,观赏鱼,玩赏鸟,奇石盆景,其他小宠".split(',');
    var xl = "小类,不限,锦鲤,七彩神仙,接吻鱼,罗汉鱼,孔雀鱼,龙鱼,红鲫鱼,中国金鱼,鹦鹉鱼,清道夫,地图鱼,招财鱼,宝莲灯鱼,鲷鱼".split(',');
...
function LoadBody(TYPE, PageIndex) {
    ...
    var condition = "PZ:" + GetCondition("PZ") + ",XL:" + GetCondition("XL") + ",JG:" + GetCondition("JG") + ",DQ:" + GetCondition("DQ");
    $.ajax({
        type: "POST",
