...
function LoadLYJDCondition() {
    LoadConditionByTypeName("国内游游玩天数", "CODES_LYJD", "游玩天数", "YWTS");
    LoadConditionByTypeName("国内游出游方式", "CODES_LYJD", "出游方式", "CYFS");
    LoadConditionByTypeName("国内游价格", "CODES_LYJD", "价格", "MSJ");
