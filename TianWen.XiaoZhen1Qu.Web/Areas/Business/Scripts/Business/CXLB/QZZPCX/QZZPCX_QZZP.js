...
function LoadESCondition() {
    ...
    LoadBody("QZZPCX_QZZP", currentIndex);
}
//选择条件
function SelectCondition(obj, name) {
    ...
    LoadBody("QZZPCX_QZZP", currentIndex);
    ShowSelectCondition("QZZPCX_QZZP");
}
//加载主体部分
...
function LoadESInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'QZZPCX_QZZP\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
