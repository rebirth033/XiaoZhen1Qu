...
function LoadNLMFYCondition() {
    LoadConditionByTypeNames("'水产类别'", "CODES_NLMFY", "类别", "LB", "15");
...
function LoadInfo(obj) {
    var html = "";
    html += ('<li class="li_body_left" onclick="OpenXXXX(\'NLMFYXX_SC\',\'' + obj.ID + '\')">');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'NLMFYXX_SC\',\'' + obj.ID + '\')" class="li_body_right">');
