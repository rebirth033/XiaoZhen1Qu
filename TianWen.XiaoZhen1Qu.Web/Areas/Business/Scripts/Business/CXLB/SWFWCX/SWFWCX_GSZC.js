...
function LoadSWFWCondition() {
    LoadConditionByTypeNames("'工商注册类别'", "CODES_SWFW", "类别", "LB", "100");
}
//加载URL查询条件
...
function LoadInfo(obj) {
    var html = "";
    html += ('<li class="li_body_left" onclick="OpenXXXX(\'SWFWXX_GSZC\',\'' + obj.ID + '\')">');
...
function LoadHotInfo(obj) {
    var html = "";
    html += ('<li onclick="OpenXXXX(\'SWFWXX_GSZC\',\'' + obj.ID + '\')" class="li_body_right">');
