    ...
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("空气净化") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("开荒保洁") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("物业保洁") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("沙发清洗") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("地毯清洗") !== -1
                    || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("地板打蜡") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("石材翻新/养护") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("除虫除蚁") !== -1 || xml.Value.SHFW_WXFW_SJSMWXJBXX.LB.indexOf("高空清洗") !== -1) {
