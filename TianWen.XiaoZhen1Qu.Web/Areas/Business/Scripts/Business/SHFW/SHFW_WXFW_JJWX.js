...
function LoadSHFW_WXFW_JJWXJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/SHFW_WXFW_JJWX/LoadSHFW_WXFW_JJWXJBXX",
        dataType: "json",
        data:
        {
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                ue.ready(function () {
                    ue.setHeight(200);
                    ue.setContent(xml.Value.SHFW_WXFW_JJWXJBXX.BCMS);
                });
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/Business/SHFW_WXFW_JJWX/FB",
        dataType: "json",
        data:
        {
