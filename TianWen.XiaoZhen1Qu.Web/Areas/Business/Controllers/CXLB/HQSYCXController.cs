...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class HQSYCXController : BaseController
    {
        ...
        {
            return Json(HQSYCXBLL.LoadHQSYXX(Request["TYPE"], Request["Condition"], Request["PageIndex"], Request["PageSize"], Request["OrderColumn"], Request["OrderType"], Session["XZQDM"].ToString()));
        }
    }
}