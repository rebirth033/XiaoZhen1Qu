...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class SWFWCXController : BaseController
    {
        ...
        {
            return Json(SWFWCXBLL.LoadSWFWXX(Request["TYPE"], Request["Condition"], Request["PageIndex"], Request["PageSize"], Request["OrderColumn"], Request["OrderType"], Session["XZQDM"].ToString()));
        }
    }
}