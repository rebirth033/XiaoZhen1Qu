...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class SHFWCXController : BaseController
    {
        ...
        public ActionResult SHFWCX_SJSMWX() { GetSession(); return View(); }

        public JsonResult LoadSHFWXX()
        {
            return Json(SHFWCXBLL.LoadSHFWXX(Request["TYPE"], Request["Condition"], Request["PageIndex"], Request["PageSize"]));
        }
    }
}