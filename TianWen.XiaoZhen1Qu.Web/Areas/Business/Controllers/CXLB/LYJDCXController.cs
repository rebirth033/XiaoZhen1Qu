...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class LYJDCXController : BaseController
    {
        ...
        {
            return Json(LYJDCXBLL.LoadLYJDXX(Request["TYPE"], Request["Condition"], Request["PageIndex"], Request["PageSize"], Request["OrderColumn"], Request["OrderType"], Session["XZQDM"].ToString()));
        }
    }
}