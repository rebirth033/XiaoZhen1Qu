...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class FCCXController : BaseController
    {
        ...
        {
            return Json(FCCXBLL.LoadFCXX(Request["TYPE"], Request["Condition"], Request["PageIndex"], Request["PageSize"], Session["XZQ"].ToString(), Request["OrderColumn"], Request["OrderType"]));
        }
    }
}