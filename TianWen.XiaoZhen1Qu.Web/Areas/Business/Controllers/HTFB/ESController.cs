...
namespace TianWen.XiaoZhen1Qu.Web.Areas.Business.Controllers
{
    public class ESController : BaseController
    {
        ...
        public JsonResult FBES_PWKQ_DYPJBXX()
        {
            ...
            object result = ES_BLL.SaveES_PWKQ_DYPJBXX(jcxx, ES_PWKQ_DYPjbxx);
            return Json(result);
        }
        [ValidateInput(false)]
        public JsonResult FBES_PWKQ_QTKQJBXX()
        {
            ...
            object result = ES_BLL.SaveES_PWKQ_QTKQJBXX(jcxx, ES_PWKQ_QTKQjbxx);
            return Json(result);
        }
        [ValidateInput(false)]
        public JsonResult FBES_PWKQ_XFKGWQJBXX()
        {
            ...
            object result = ES_BLL.SaveES_PWKQ_XFKGWQJBXX(jcxx, ES_PWKQ_XFKGWQjbxx);
            return Json(result);
        }
        [ValidateInput(false)]
        public JsonResult FBES_PWKQ_YCMPJBXX()
        {
            ...
            object result = ES_BLL.SaveES_PWKQ_YCMPJBXX(jcxx, ES_PWKQ_YCMPjbxx);
            return Json(result);
        }
        [ValidateInput(false)]
        public JsonResult FBES_PWKQ_YLYJDPJBXX()
        {
            ...
            object result = ES_BLL.SaveES_PWKQ_YLYJDPJBXX(jcxx, ES_PWKQ_YLYJDPjbxx);
            return Json(result);
        }
        ...
        {
            string ID = Request["ID"];
            object result = ES_BLL.LoadES_PWKQ_DYPJBXX(ID);
            return Json(result);
        }
        public JsonResult LoadES_PWKQ_QTKQJBXX()
        {
            string ID = Request["ID"];
            object result = ES_BLL.LoadES_PWKQ_QTKQJBXX(ID);
            return Json(result);
        }
        public JsonResult LoadES_PWKQ_XFKGWQJBXX()
        {
            string ID = Request["ID"];
            object result = ES_BLL.LoadES_PWKQ_XFKGWQJBXX(ID);
            return Json(result);
        }
        public JsonResult LoadES_PWKQ_YCMPJBXX()
        {
            string ID = Request["ID"];
            object result = ES_BLL.LoadES_PWKQ_YCMPJBXX(ID);
            return Json(result);
        }
        public JsonResult LoadES_PWKQ_YLYJDPJBXX()
        {
            string ID = Request["ID"];
            object result = ES_BLL.LoadES_PWKQ_YLYJDPJBXX(ID);
            return Json(result);
        }
    }
}