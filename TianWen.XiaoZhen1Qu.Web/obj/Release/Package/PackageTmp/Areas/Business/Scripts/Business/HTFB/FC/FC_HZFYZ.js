...
function InfoXQMC() {
    ...
    $("#divXQMCTip").html('<img src="' + getRootPath() + '/Areas/Business/Css/images/info_purple.png" class="imgTip" />请选择小区名称');
...
function InfoFWLX_S() {
    ...
    $("#divFWLXTip").html('<img src="' + getRootPath() + '/Areas/Business/Css/images/info_purple.png" class="imgTip" />请填写整数，不能是0');
...
function InfoFWLX_T() {
    $("#divFWLXTip").css("display", "block");
    $("#divFWLXTip").attr("class", "Info");
    $("#divFWLXTip").html('<img src="' + getRootPath() + '/Areas/Business/Css/images/info_purple.png" class="imgTip" />请填写整数，没有请填0');
...
function InfoLCFB_C() {
    ...
    $("#divLCFBTip").html('<img src="' + getRootPath() + '/Areas/Business/Css/images/info_purple.png" class="imgTip" />请填写整数，地下室用负数填写，不能为0');
...
function InfoLCFB_GJC() {
    $("#divLCFBTip").css("display", "block");
    $("#divLCFBTip").attr("class", "Info");
    $("#divLCFBTip").html('<img src="' + getRootPath() + '/Areas/Business/Css/images/info_purple.png" class="imgTip" />请填写整数，不能为0');
