        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < (xml.list.length > 10 ? 10 : xml.list.length) ; i++) {
                    ...
                    html += "<li class='li_select' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITION + "' onclick='SelectSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITIONS + "\")'>" + xqmchtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < (xml.list.length > 10 ? 10 : xml.list.length) ; i++) {
                    ...
                    html += "<li class='li_select' style='width:501px;' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITIONS + "' onclick='SelectHideSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITIONS + "\")'>" + xqmchtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < xml.list.length; i++) {
                    ...
                    html += "<li class='li_select' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITIONS + "' onclick='SelectSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITIONS + "\")'>" + SShtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
                $("#divSSJGlist").html(html);
                $("#divSSJGlist").css("display", "block");
        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                ...
                for (var i = 0; i < xml.list.length; i++) {
                    ...
                    html += "<li class='li_select' style='width:501px;' codename='" + xml.list[i].CODENAME + "' codeid='" + xml.list[i].CODEID + "' url='" + xml.list[i].URL + "' parentid='" + xml.list[i].PARENTID + "' condition='" + xml.list[i].CONDITIONS + "' onclick='SelectHideSSJG(\"" + xml.list[i].CODENAME + "\",\"" + xml.list[i].CODEID + "\",\"" + xml.list[i].URL + "\",\"" + xml.list[i].PARENTID + "\",\"" + xml.list[i].CONDITIONS + "\")'>" + SShtml + "&nbsp;&nbsp;<span style='color:#999999;font-size:12px;'>" + RTrimStr((xml.list[i].TYPENAME === null ? "" : xml.list[i].TYPENAME), "类别") + "</span>" + "</li>";
                }
                html += "</ul>";
                $("#divHideSSJGlist").html(html);
                $("#divHideSSJGlist").css("display", "block");
...
function OpenSSJGByInput() {
    $.ajax({
        ...
        success: function (xml) {
            if (xml.Result === 1 && xml.list.length > 0) {
                SelectSSJG(xml.list[0].CODENAME, xml.list[0].CODEID, xml.list[0].URL, xml.list[0].PARENTID, xml.list[0].CONDITIONS);
                var url = "";
                if ($("#URL").val().split('_')[0] === "ES") {
                    url = "/" + $("#URL").val().split('_')[0] + "CX/" + $("#URL").val().split('_')[0] + "CX_" + $("#URL").val().split('_')[1] + "_" + $("#URL").val().split('_')[2];
                }
