...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/LoadSHFW_SHPSJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.SHFW_SHPSJBXX.LB !== null)
                    SetDuoX("LB", xml.Value.SHFW_SHPSJBXX.LB);
                if (xml.Value.SHFW_SHPSJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.SHFW_SHPSJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/SHFW/FBSHFW_SHPSJBXX",
        dataType: "json",
        data:
        {
