...
function LoadESCondition() {
    LoadConditionByTypeNames("'文体/户外/乐器类别','户外用品价格'", "CODES_ES_WHYL", "类别,价格", "LB,JG", "100,100");
}
//加载URL查询条件
...
function LoadInfo(obj) {
    ...
    html += ('<p class="p_li_body_left_center_bt" onclick="OpenXXXX(\'ESXX_WHYL_WTHWYQ\',\'' + obj.ID + '\')">' + obj.BT + '</p>');
