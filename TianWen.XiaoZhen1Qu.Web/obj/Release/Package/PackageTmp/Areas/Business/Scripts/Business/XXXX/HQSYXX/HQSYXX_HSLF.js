...
function LoadJBXX(obj) {
    ...
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">风格：</span>');
    ...
    html += ('<span class="span_body_left_body_right_right">' + obj.DGZQ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">材质：</span>');
    html += ('<span class="span_body_left_body_right_right">' + obj.CZ + '</span>');
    html += ('</p>');
    html += ('<p class="p_body_left_body_right">');
    html += ('<span class="span_body_left_body_right_left">款式：</span>');
