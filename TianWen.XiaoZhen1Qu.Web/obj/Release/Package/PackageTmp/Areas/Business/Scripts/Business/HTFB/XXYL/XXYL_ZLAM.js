...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/XXYL/LoadXXYL_ZLAMJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                $("#spanQY").html(xml.Value.XXYL_ZLAMJBXX.QY);
                $("#spanDD").html(xml.Value.XXYL_ZLAMJBXX.DD);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/XXYL/FBXXYL_ZLAMJBXX",
        dataType: "json",
        data:
        {
