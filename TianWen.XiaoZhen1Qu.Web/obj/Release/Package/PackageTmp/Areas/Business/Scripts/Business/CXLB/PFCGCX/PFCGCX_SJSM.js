...
function LoadPFCGCondition() {
    LoadConditionByTypeNames("'手机数码类别'", "CODES_PFCG", "类别", "LB", "100");
}
//加载URL查询条件
...
function SelectCondition(obj, name) {
    ...
    LoadBody("PFCGXX_SJSM", currentIndex);
    ShowSelectCondition("PFCGXX_SJSM");
}
//选择URL条件
...
function LoadInfo(obj) {
    ...
    html += ('<img class="img_li_body_left" onclick="OpenXXXX(\'PFCGXX_SJSM\',\'' + obj.ID + '\')" src="' + getRootPath() + "/Areas/Business/Photos/" + obj.YHID + "/" + obj.PHOTOS[0].PHOTONAME + "?j=" + Math.random() + '" />');
