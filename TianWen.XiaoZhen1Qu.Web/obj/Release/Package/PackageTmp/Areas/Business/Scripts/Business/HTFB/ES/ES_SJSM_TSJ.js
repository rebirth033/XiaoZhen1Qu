...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ES/LoadES_SJSM_TSJJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                if (xml.Value.ES_SJSM_TSJJBXX.PSFS !== null)
                    SetDuoX("PSFS", xml.Value.ES_SJSM_TSJJBXX.PSFS);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/ES/FBES_SJSM_TSJJBXX",
        dataType: "json",
        data:
        {
