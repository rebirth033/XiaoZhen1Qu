...
function LoadJBXX() {
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/LoadPFCG_YBYQJBXX",
        dataType: "json",
        data:
        {
            ID: getUrlParam("ID")
        ...
        success: function (xml) {
            if (xml.Result === 1) {
                ...
                LoadXL(xml.Value.PFCG_YBYQJBXX.LB, xml.Value.PFCG_YBYQJBXX.XL);
                if (xml.Value.PFCG_YBYQJBXX.FWFW !== null)
                    SetDuoX("FWFW", xml.Value.PFCG_YBYQJBXX.FWFW);
...
function FB() {
    ...
    $.ajax({
        type: "POST",
        url: getRootPath() + "/PFCG/FBPFCG_YBYQJBXX",
        dataType: "json",
        data:
        {
