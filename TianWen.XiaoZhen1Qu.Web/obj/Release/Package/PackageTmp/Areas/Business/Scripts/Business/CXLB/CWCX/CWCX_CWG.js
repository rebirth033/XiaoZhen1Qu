...
function LoadInfo(obj) {
    var html = "";
    html += ('<li class="li_body_left" onclick="OpenXXXX(\'CWXX_CWG\',\'' + obj.ID + '\')">');
    ...
    html += ('<p class="p_li_body_left_center_cs font_size16">' + obj.NL + obj.NLDW + ' / ' + obj.YMQK + '疫苗<label>/</label>' + obj.QCQK + ' / ' + obj.ZSZS + '只在售</p>');
