    ...
    public class SYBLL : BaseBLL, ISYBLL
    {
        ...
        public object LoadKeyWordByHZ(string SS, string XZQ)
        {
            try
            {
                ...
                DataTable list = DAO.Repository.GetDataTable(string.Format("SELECT LBNAME CODENAME, LBID CODEID, FBYM URL, PARENTID PARENTID FROM CODES_XXLB WHERE LBNAME LIKE '%{0}%'", SS));
