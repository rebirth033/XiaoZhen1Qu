    ...
    public class ESCXBLL : BaseBLL, IESCXBLL
    {
        ...
        public object LoadESXX(string TYPE, string Condition, string PageIndex, string PageSize)
        {
            try
            {
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_myfzmr_fzxmxbjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_myfzmr_mrbjjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_whyl_yspscpjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_whyl_wthwyqjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_whyl_tsyxrjjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
                ...
                {
                    dt = DAO.Repository.GetDataTable("select a.*,b.* from jcxx a,es_whyl_wyxnwpjbxx b where a.jcxxid = b.jcxxid " + GetConditin(Condition) + " order by zxgxsj desc");
                    var list = ConvertHelper.DataTableToList<ES_JDJJBG_BGSBView>(dt);
                    int PageCount = (list.Count + int.Parse(PageSize) - 1) / int.Parse(PageSize);
                    int TotalCount = list.Count;
