        ...
        public object LoadPWKQ_YLYJDPJBXX(string PWKQ_YLYJDPJBXXID)
        {
            try
            {
                ...
                if (PWKQ_YLYJDPJBXX != null)
                {
                    ...
                    return new { Result = EnResultType.Success, Message = "载入成功", Value = new { PWKQ_YLYJDPJBXX = PWKQ_YLYJDPJBXX, JCXX = jcxx, Photos = GetPhtosByJCXXID(PWKQ_YLYJDPJBXX.JCXXID) } };
                }
                else
                {
